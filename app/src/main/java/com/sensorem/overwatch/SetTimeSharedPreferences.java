...
public class SetTimeSharedPreferences {
    ...
    * GET FUNCTIONS*/
    ...
    public String getMondayArm (){
        return sharedPreferences.getString(MONDAY_ARM, null);
    }

    public String getMondayDisarm(){
        return sharedPreferences.getString(MONDAY_DISARM,null);
    }

    public String getTuesdayArm(){
        return sharedPreferences.getString(TUESDAY_ARM, null);
    }

    public String getTuesdayDisarm (){
        return sharedPreferences.getString(TUESDAY_DISARM, null);
    }

    public String getWednesdayArm (){
        return sharedPreferences.getString(WEDNESDAY_ARM, null);
    }

    public String getWednesdayDisarm (){
        return sharedPreferences.getString(WEDNESDAY_DISARM, null);
    }

    public String getThursdayArm (){
        return sharedPreferences.getString(THURSDAY_ARM, null);
    }

    public String getThursdayDisarm (){
        return sharedPreferences.getString(THURSDAY_DISARM, null);
    }

    public String getFridayArm (){
        return sharedPreferences.getString(FRIDAY_ARM, null);
    }

    public String getFridayDisarm (){
        return sharedPreferences.getString(FRIDAY_DISARM, null);
    }

    public String getSaturdayArm (){
        return sharedPreferences.getString(SATURDAY_ARM, null);
    }

    public String getSaturdayDisarm (){
        return sharedPreferences.getString(SATURDAY_DISARM, null);
    }

    public String getSundayArm (){
        return sharedPreferences.getString(SUNDAY_ARM, null);
    }

    public String getSundayDisarm (){
        return sharedPreferences.getString(SUNDAY_DISARM, null);
    }
